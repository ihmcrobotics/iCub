...
public class JointDesiredPubSubType implements us.ihmc.pubsub.TopicDataType<it.iit.iCub.messages.it.iit.yarp.JointDesired>
{
    ...
    @Override
   public void serialize(it.iit.iCub.messages.it.iit.yarp.JointDesired data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, it.iit.iCub.messages.it.iit.yarp.JointDesired data) throws java.io.IOException
   {
   ...
   public static void read(it.iit.iCub.messages.it.iit.yarp.JointDesired data, us.ihmc.idl.CDR cdr)
   {
	...
	{
	    			data.setControlMode((it.iit.iCub.messages.it.iit.yarp.ORSControlMode)ser.read_type_c("controlMode", it.iit.iCub.messages.it.iit.yarp.ORSControlMode.class));
