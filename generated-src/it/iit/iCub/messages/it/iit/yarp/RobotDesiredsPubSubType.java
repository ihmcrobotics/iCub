...
public class RobotDesiredsPubSubType implements us.ihmc.pubsub.TopicDataType<it.iit.iCub.messages.it.iit.yarp.RobotDesireds>
{
   ...
   public final static int getCdrSerializedSize(it.iit.iCub.messages.it.iit.yarp.RobotDesireds data, int current_alignment)
   {
      ...
      current_alignment += 4 + us.ihmc.idl.CDR.alignment(current_alignment, 4);
      for (int i0 = 0; i0 < data.getJointDesireds().size(); ++i0)
      {
         current_alignment += it.iit.iCub.messages.it.iit.yarp.JointDesiredPubSubType.getCdrSerializedSize(data.getJointDesireds().get(i0), current_alignment);
      }
   ...
   public static void write(it.iit.iCub.messages.it.iit.yarp.RobotDesireds data, us.ihmc.idl.CDR cdr)
   {
      ...
      if (data.getJointDesireds().size() <= 100)
         cdr.write_type_e(data.getJointDesireds());
      else
   ...
   @Override
   public void serialize(it.iit.iCub.messages.it.iit.yarp.RobotDesireds data, us.ihmc.pubsub.common.SerializedPayload serializedPayload)
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, it.iit.iCub.messages.it.iit.yarp.RobotDesireds data)
         throws java.io.IOException
   {
