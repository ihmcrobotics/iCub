...
public class ForceSensorPubSubType implements us.ihmc.pubsub.TopicDataType<it.iit.iCub.messages.it.iit.yarp.ForceSensor>
{
    ...
    @Override
   public void serialize(it.iit.iCub.messages.it.iit.yarp.ForceSensor data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, it.iit.iCub.messages.it.iit.yarp.ForceSensor data) throws java.io.IOException
   {
