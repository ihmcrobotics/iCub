...
{
   public final static int torso_pitch = 0;
   public final static int torso_roll = 1;
   public final static int torso_yaw = 2;
   public final static int l_shoulder_pitch = 3;
   public final static int l_shoulder_roll = 4;
   public final static int l_shoulder_yaw = 5;
   public final static int l_elbow = 6;
   public final static int r_shoulder_pitch = 7;
   public final static int r_shoulder_roll = 8;
   public final static int r_shoulder_yaw = 9;
   public final static int r_elbow = 10;
   public final static int l_hip_pitch = 11;
   public final static int l_hip_roll = 12;
   public final static int l_hip_yaw = 13;
   public final static int l_knee = 14;
   public final static int l_ankle_pitch = 15;
   public final static int l_ankle_roll = 16;
   public final static int r_hip_pitch = 17;
   public final static int r_hip_roll = 18;
   public final static int r_hip_yaw = 19;
   public final static int r_knee = 20;
   public final static int r_ankle_pitch = 21;
   public final static int r_ankle_roll = 22;
   public final static int l_wrist_prosup = 23;
   public final static int l_wrist_pitch = 24;
   public final static int l_wrist_yaw = 25;
   public final static int neck_pitch = 26;
   public final static int neck_roll = 27;
   public final static int neck_yaw = 28;
